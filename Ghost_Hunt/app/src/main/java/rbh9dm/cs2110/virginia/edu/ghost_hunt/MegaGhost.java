...
/**
 * Created by matthewleon on 4/22/15.
 */
public class MegaGhost extends Ghost {
    ...
    public MegaGhost(Bitmap bitmap, int x, int y, int fps, int frameNr, int numStill, int numUp, int numLeft, int numRight, int numDown, int speed, double angle, Background background) {
        super(bitmap, x, y, fps, frameNr, numStill, numUp, numLeft, numRight, numDown, speed, angle, background);
        this.speed = speed;
        this.angle = angle;
    ...
    public void setGhostDamage(int damage){
